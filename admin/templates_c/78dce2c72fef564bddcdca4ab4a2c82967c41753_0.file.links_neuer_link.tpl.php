<?php
/* Smarty version 3.1.38, created on 2021-05-18 13:36:21
  from 'C:\Users\omayma\Desktop\xampp\htdocs\shop\admin\templates\bootstrap\tpl_inc\links_neuer_link.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.38',
  'unifunc' => 'content_60a3a6b5cf2609_47307772',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '78dce2c72fef564bddcdca4ab4a2c82967c41753' => 
    array (
      0 => 'C:\\Users\\omayma\\Desktop\\xampp\\htdocs\\shop\\admin\\templates\\bootstrap\\tpl_inc\\links_neuer_link.tpl',
      1 => 1612177964,
      2 => 'file',
    ),
  ),
...
function content_60a3a6b5cf2609_47307772 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
...
echo "<a href=\"links.php?action=edit-link&kLink=";
...
echo $_smarty_tpl->tpl_vars['Link']->value->getIdentifier();
                    ...
                    <div class="form-group form-row align-items-center">
                        <label class="col col-sm-4 col-form-label text-sm-right" for="lang"><?php echo __('language');?>
:</label>
                        <div class="col-sm pl-sm-3 pr-sm-5 order-last order-sm-2">
...
?>
                                    <option value="<?php echo $_smarty_tpl->tpl_vars['language']->value->getIso();?>
" <?php if ($_smarty_tpl->tpl_vars['language']->value->getShopDefault() === 'Y') {?>selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['language']->value->getLocalizedName();?>
...
" class="iso_wrapper<?php if (!$_smarty_tpl->tpl_vars['language']->value->isShopDefault()) {?> hidden-soft<?php }?>">
                    <div class="card">
                        <div class="card-header">
...
echo $_smarty_tpl->tpl_vars['Link']->value->getTitle($_smarty_tpl->tpl_vars['langID']->value);
                                ...
                                <div class="col-auto ml-sm-n4 order-2 order-sm-3"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['getHelpDesc'][0], array( array('cDesc'=>__('titleDesc')),$_smarty_tpl ) );?>
</div>
                            </div>
                            <div class="form-group form-row align-items-center">
                                <?php $_smarty_tpl->_assignInScope('cContent_ISO', ('cContent_').($_smarty_tpl->tpl_vars['cISO']->value));?>
                                <label class="col col-sm-4 col-form-label text-sm-right" for="cContent_<?php echo $_smarty_tpl->tpl_vars['cISO']->value;?>
"><?php echo __('content');?>
:</label>
                                <div class="col-sm pl-sm-3 pr-sm-5 order-last order-sm-2">
                                    <textarea class="form-control ckeditor" id="cContent_<?php echo $_smarty_tpl->tpl_vars['cISO']->value;?>
" name="cContent_<?php echo $_smarty_tpl->tpl_vars['cISO']->value;?>
" rows="10" cols="40"><?php if ((isset($_smarty_tpl->tpl_vars['xPostVar_arr']->value[$_smarty_tpl->tpl_vars['cContent_ISO']->value])) && $_smarty_tpl->tpl_vars['xPostVar_arr']->value[$_smarty_tpl->tpl_vars['cContent_ISO']->value]) {
echo $_smarty_tpl->tpl_vars['xPostVar_arr']->value[$_smarty_tpl->tpl_vars['cContent_ISO']->value];
} elseif (!empty($_smarty_tpl->tpl_vars['Link']->value->getContent($_smarty_tpl->tpl_vars['langID']->value))) {
echo $_smarty_tpl->tpl_vars['Link']->value->getContent($_smarty_tpl->tpl_vars['langID']->value);
}?></textarea>
                                </div>
                                <div class="col-auto ml-sm-n4 order-2 order-sm-3"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['getHelpDesc'][0], array( array('cDesc'=>__('titleDesc')),$_smarty_tpl ) );?>
</div>
                            ...
                            <div class="form-group form-row align-items-center">
                                ...
                                <label class="col col-sm-4 col-form-label text-sm-right" for="cMetaTitle_<?php echo $_smarty_tpl->tpl_vars['cISO']->value;?>
...
echo $_smarty_tpl->tpl_vars['xPostVar_arr']->value[$_smarty_tpl->tpl_vars['cMetaTitle_ISO']->value];
} elseif (!empty($_smarty_tpl->tpl_vars['Link']->value->getMetaTitle($_smarty_tpl->tpl_vars['langID']->value))) {
echo $_smarty_tpl->tpl_vars['Link']->value->getMetaTitle($_smarty_tpl->tpl_vars['langID']->value);
}?>" tabindex="9" />
                                </div>
                                <div class="col-auto ml-sm-n4 order-2 order-sm-3"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['getHelpDesc'][0], array( array('cDesc'=>__('metaTitleDesc')),$_smarty_tpl ) );?>
</div>
                            </div>
                            <div class="form-group form-row align-items-center">
                            <?php $_smarty_tpl->_assignInScope('cMetaKeywords_ISO', ('cMetaKeywords_').($_smarty_tpl->tpl_vars['cISO']->value));?>
                                <label class="col col-sm-4 col-form-label text-sm-right" for="cMetaKeywords_<?php echo $_smarty_tpl->tpl_vars['cISO']->value;?>
"><?php echo __('metaKeywords');?>
:</label>
                                <div class="col-sm pl-sm-3 pr-sm-5 order-last order-sm-2">
                                    <input class="form-control" type="text" name="cMetaKeywords_<?php echo $_smarty_tpl->tpl_vars['cISO']->value;?>
...
echo $_smarty_tpl->tpl_vars['xPostVar_arr']->value[$_smarty_tpl->tpl_vars['cMetaKeywords_ISO']->value];
} elseif (!empty($_smarty_tpl->tpl_vars['Link']->value->getMetaKeyword($_smarty_tpl->tpl_vars['langID']->value))) {
echo $_smarty_tpl->tpl_vars['Link']->value->getMetaKeyword($_smarty_tpl->tpl_vars['langID']->value);
}?>" tabindex="9" />
                                </div>
                                <div class="col-auto ml-sm-n4 order-2 order-sm-3"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['getHelpDesc'][0], array( array('cDesc'=>__('metaKeywordsDesc')),$_smarty_tpl ) );?>
</div>
                            </div>
                            <div class="form-group form-row align-items-center">
                                <?php $_smarty_tpl->_assignInScope('cMetaDescription_ISO', ('cMetaDescription_').($_smarty_tpl->tpl_vars['cISO']->value));?>
                                <label class="col col-sm-4 col-form-label text-sm-right" for="cMetaDescription_<?php echo $_smarty_tpl->tpl_vars['cISO']->value;?>
"><?php echo __('metaDescription');?>
:</label>
                                <div class="col-sm pl-sm-3 pr-sm-5 order-last order-sm-2">
                                    <input class="form-control" type="text" name="cMetaDescription_<?php echo $_smarty_tpl->tpl_vars['cISO']->value;?>
...
echo $_smarty_tpl->tpl_vars['xPostVar_arr']->value[$_smarty_tpl->tpl_vars['cMetaDescription_ISO']->value];
} elseif (!empty($_smarty_tpl->tpl_vars['Link']->value->getMetaDescription($_smarty_tpl->tpl_vars['langID']->value))) {
echo $_smarty_tpl->tpl_vars['Link']->value->getMetaDescription($_smarty_tpl->tpl_vars['langID']->value);
}?>" tabindex="9" />
                                </div>
                                <div class="col-auto ml-sm-n4 order-2 order-sm-3"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['getHelpDesc'][0], array( array('cDesc'=>__('metaDescriptionDesc')),$_smarty_tpl ) );?>
</div>
                            </div>
                        </div>
                    </div>
