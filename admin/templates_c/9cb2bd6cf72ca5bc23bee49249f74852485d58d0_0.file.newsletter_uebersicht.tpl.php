...
/* Smarty version 3.1.38, created on 2021-05-04 12:21:18
  from 'C:\xampp\htdocs\shop\admin\templates\bootstrap\tpl_inc\newsletter_uebersicht.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.38',
  'unifunc' => 'content_6091201e83cf64_56077892',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '9cb2bd6cf72ca5bc23bee49249f74852485d58d0' => 
    array (
  ...
  array (
    ...
    'file:tpl_inc/pagination.tpl' => 5,
    'file:tpl_inc/config_section.tpl' => 1,
  ),
),false)) {
function content_6091201e83cf64_56077892 (Smarty_Internal_Template $_smarty_tpl) {
...
<div id="content">
    <div class="card">
        <div class="card-body">
            <?php $_smarty_tpl->_subTemplateRender('file:tpl_inc/language_switcher.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('action'=>'newsletter.php'), 0, false);
?>
        </div>
    </div>
    <div class="tabs">
                ...
                <?php if ((isset($_smarty_tpl->tpl_vars['oNewsletterEmpfaenger_arr']->value)) && count($_smarty_tpl->tpl_vars['oNewsletterEmpfaenger_arr']->value) > 0) {?>
                    <div class="search-toolbar mb-3">
                        <form name="suche" method="post" action="newsletter.php">
                            ...
                            <?php if ((isset($_smarty_tpl->tpl_vars['cSucheInaktiv']->value)) && strlen($_smarty_tpl->tpl_vars['cSucheInaktiv']->value) > 0) {?>
...
:</label>
                                <div class="col-sm-auto mb-3">
                                    <input class="form-control" id="cSucheInaktiv" name="cSucheInaktiv" type="text" value="<?php if ((isset($_smarty_tpl->tpl_vars['cSucheInaktiv']->value)) && strlen($_smarty_tpl->tpl_vars['cSucheInaktiv']->value) > 0) {
...
echo $_smarty_tpl->tpl_vars['oNewsletterEmpfaenger']->value->newsNachname;
                                                ...
                                                <td class="text-left"><?php if ((isset($_smarty_tpl->tpl_vars['oNewsletterEmpfaenger']->value->cName)) && strlen($_smarty_tpl->tpl_vars['oNewsletterEmpfaenger']->value->cName) > 0) {
                ...
                <?php if ((isset($_smarty_tpl->tpl_vars['oAbonnenten_arr']->value)) && count($_smarty_tpl->tpl_vars['oAbonnenten_arr']->value) > 0) {?>
                    <div class="search-toolbar mb-3">
                        <form name="suche" method="post" action="newsletter.php">
                            ...
                            <?php if ((isset($_smarty_tpl->tpl_vars['cSucheAktiv']->value)) && strlen($_smarty_tpl->tpl_vars['cSucheAktiv']->value) > 0) {?>
...
:</label>
                                    <div class="col-sm-auto mb-3">
                                        <input id="cSucheAktiv" name="cSucheAktiv" class="form-control" type="text" value="<?php if ((isset($_smarty_tpl->tpl_vars['cSucheAktiv']->value)) && strlen($_smarty_tpl->tpl_vars['cSucheAktiv']->value) > 0) {
...
?>
                                            <?php if ((isset($_smarty_tpl->tpl_vars['oNewsletterQueue']->value->nAnzahlEmpfaenger)) && $_smarty_tpl->tpl_vars['oNewsletterQueue']->value->nAnzahlEmpfaenger > 0) {?>
                                                <tr>
                                                    <td>
                                                        <div class="custom-control custom-checkbox">
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group">
                                                        <a class="btn btn-link px-2"
                                                           href="newsletter.php?&vorschau=<?php echo $_smarty_tpl->tpl_vars['oNewsletterVorlage']->value->kNewsletterVorlage;?>
...
"
                                                        ...
                                                        <?php if ($_smarty_tpl->tpl_vars['oNewsletterVorlage']->value->kNewslettervorlageStd > 0) {?>
                                                            <a class="btn btn-link px-2"
                                                               href="newsletter.php?newslettervorlagenstd=1&editieren=<?php echo $_smarty_tpl->tpl_vars['oNewsletterVorlage']->value->kNewsletterVorlage;?>
...
"
                                                        ...
                                                        <?php } else { ?>
                                                            <a class="btn btn-link px-2"
                                                               href="newsletter.php?newslettervorlagen=1&editieren=<?php echo $_smarty_tpl->tpl_vars['oNewsletterVorlage']->value->kNewsletterVorlage;?>
&tab=newslettervorlagen&token=<?php echo $_SESSION['jtl_token'];?>
"
                                                               title="<?php echo __('modify');?>
"
                                                        ...
                                                        <?php }?>
                                                        <a class="btn btn-link px-2"
                                                           href="newsletter.php?newslettervorlagen=1&vorbereiten=<?php echo $_smarty_tpl->tpl_vars['oNewsletterVorlage']->value->kNewsletterVorlage;?>
&tab=newslettervorlagen&token=<?php echo $_SESSION['jtl_token'];?>
"
...
"></label>
                                                ...
                                                <td class="text-left">
                                                    <a href="newsletter.php?newsletterhistory=1&anzeigen=<?php echo $_smarty_tpl->tpl_vars['oNewsletterHistory']->value->kNewsletterHistory;?>
