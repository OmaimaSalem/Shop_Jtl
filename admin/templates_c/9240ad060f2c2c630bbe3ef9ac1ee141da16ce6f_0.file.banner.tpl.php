<?php
/* Smarty version 3.1.38, created on 2021-05-04 12:24:15
  from 'C:\xampp\htdocs\shop\admin\templates\bootstrap\banner.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.38',
  'unifunc' => 'content_609120cf2bff86_01738168',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '9240ad060f2c2c630bbe3ef9ac1ee141da16ce6f' => 
    array (
      0 => 'C:\\xampp\\htdocs\\shop\\admin\\templates\\bootstrap\\banner.tpl',
      1 => 1612177964,
      2 => 'file',
    ),
  ),
...
function content_609120cf2bff86_01738168 (Smarty_Internal_Template $_smarty_tpl) {
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                        ...
                        <?php } else { ?>
                            <?php ob_start();
echo __('warningNoBannerInDir');
$_prefixVariable2 = ob_get_clean();
ob_start();
echo (defined('PFAD_BILDER_BANNER') ? constant('PFAD_BILDER_BANNER') : null);
...
$_smarty_tpl->_subTemplateRender("file:snippets/daterange_picker.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('datepickerID'=>"#vDatum",'currentDate'=>$_prefixVariable4,'format'=>"DD.MM.YYYY",'separator'=>$_prefixVariable5,'single'=>true), 0, false);
?>
                    </div>
                    <div class="form-group form-row align-items-center">
...
$_smarty_tpl->_subTemplateRender("file:snippets/daterange_picker.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('datepickerID'=>"#bDatum",'currentDate'=>$_prefixVariable6,'format'=>"DD.MM.YYYY",'separator'=>$_prefixVariable7,'single'=>true), 0, true);
?>
                    </div>
                </div><!-- /.panel-body -->
            </div><!-- /.panel -->
...
" />
                                        <div class="btn-group">
                                            <button class="btn btn-link px-2" name="action" value="delete" title="<?php echo __('delete');?>
" data-toggle="tooltip">
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
            ...
            <div class="card-footer save-wrapper">
                <div class="row">
                    <div class="ml-auto col-sm-6 col-xl-auto">
                        <a class="btn btn-primary btn-block" href="banner.php?action=new&token=<?php echo $_SESSION['jtl_token'];?>
">
