...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.38',
  'unifunc' => 'content_609117e9654908_54532995',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'dcc64471676b19de1e111bca7e52e9d403524ef0' => 
    array (
...
function content_609117e9654908_54532995 (Smarty_Internal_Template $_smarty_tpl) {
...
>
    ...
    <?php if ($_smarty_tpl->tpl_vars['params']->value['append']->hasValue()) {?>
        <?php $_block_plugin8 = isset($_smarty_tpl->smarty->registered_plugins['block']['inputgroupaddon'][0][0]) ? $_smarty_tpl->smarty->registered_plugins['block']['inputgroupaddon'][0][0] : null;
...
$_block_repeat=true;
echo $_block_plugin8->render(array('append'=>true,'is-text'=>true), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
echo $_smarty_tpl->tpl_vars['params']->value['append']->getValue();
$_block_repeat=false;
echo $_block_plugin8->render(array('append'=>true,'is-text'=>true), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
