<?php
/* Smarty version 3.1.38, created on 2021-05-18 11:16:20
  from 'C:\Users\omayma\Desktop\xampp\htdocs\shop\admin\opc\tpl\startmenu.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.38',
  'unifunc' => 'content_60a385e4833f60_98647746',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '267977f590e4e821816e22b4c5f35dd99ca08230' => 
    array (
      0 => 'C:\\Users\\omayma\\Desktop\\xampp\\htdocs\\shop\\admin\\opc\\tpl\\startmenu.tpl',
      1 => 1612177965,
      2 => 'file',
    ),
  ),
...
function content_60a385e4833f60_98647746 (Smarty_Internal_Template $_smarty_tpl) {
if ($_smarty_tpl->tpl_vars['opc']->value->isEditMode() === false && $_smarty_tpl->tpl_vars['opc']->value->isPreviewMode() === false && \JTL\Shop::isAdmin(true)) {?>
    ...
    <?php $_smarty_tpl->_assignInScope('opcStartUrl', ((string)$_smarty_tpl->tpl_vars['ShopURL']->value)."/admin/opc.php");?>
    ...
    <?php $_block_plugin32 = isset($_smarty_tpl->smarty->registered_plugins['block']['inline_script'][0][0]) ? $_smarty_tpl->smarty->registered_plugins['block']['inline_script'][0][0] : null;
if (!is_callable(array($_block_plugin32, 'inlineScript'))) {
throw new SmartyException('block tag \'inline_script\' not callable or registered');
}
$_smarty_tpl->smarty->_cache['_tag_stack'][] = array('inline_script', array());
$_block_repeat=true;
echo $_block_plugin32->inlineScript(array(), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
echo '<script'; ?>
>
...
echo $_block_plugin32->inlineScript(array(), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
...
">
                ...
                <?php $_block_plugin33 = isset($_smarty_tpl->smarty->registered_plugins['block']['alert'][0][0]) ? $_smarty_tpl->smarty->registered_plugins['block']['alert'][0][0] : null;
...
$_block_repeat=true;
echo $_block_plugin33->render(array('variant'=>'danger'), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
                <?php echo __('opcNotSupportedPage');?>

                <?php $_block_repeat=false;
echo $_block_plugin33->render(array('variant'=>'danger'), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
            </div>
        <?php } elseif (count($_smarty_tpl->tpl_vars['pageDrafts']->value) === 0 && $_smarty_tpl->tpl_vars['shopHasUpdates']->value === false) {?>
            <nav id="opc-startmenu">
